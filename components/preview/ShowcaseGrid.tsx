...
// ── Data ─────────────────────────────────────────────────────────
const EXPENSE_ITEMS = [
  { label: "Uncategorized", amount: "$4,201", stop: 400 },
  { label: "Groceries",     amount: "$4,875", stop: 600 },
  { label: "Restaurant",    amount: "$4,815", stop: 800 },
];
          ...
          {EXPENSE_ITEMS.map((item) => (
            <div key={item.label} className="flex items-center gap-2 text-xs">
              <div
                ...
                style={{ backgroundColor: `var(--p-${item.stop})` }}
              />
          ...
          {BLOG_POSTS.map((post, i) => (
            <div key={post.title} className="flex items-center gap-3">
              <div
                ...
                style={{ background: `linear-gradient(135deg, var(--p-${[300, 400, 500][i]}), var(--p-${[500, 600, 700][i]}))` }}
              />
      ...
      <Card className="col-span-2 p-5">
        <div className="flex items-center gap-5">
          ...
          <div
            ...
            style={{ background: `linear-gradient(135deg, var(--p-400), var(--p-700))` }}
          />
        </div>
      </Card>
